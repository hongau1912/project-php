                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Tạo dịch vụ cho hệ thống cắt tóc <strong>MAN HAIR SALON</strong>. </p>
                            <form action="formadd-back.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="content" id="email" placeholder="" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label" for="Subject">Price</label>
                                        <input type="text" name="price" id="Subject" placeholder="" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button id="singlebutton" type="submit" name="create" class="btn btn-default">Create</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
