            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        <h2 class="page-title">Booking UPDATE</h2>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Chào mừng bạn đến với hệ thống đặt lịch cắt tóc của <strong>MAN HAIR SALON</strong>. Hãy chọn cập nhật mà bạn muốn đến với chúng tôi !</p>
                            <?php
                            $id = $_GET["id"];
                            ...
                            ?>
                            <form action="./booking-update-back.php?id=<?php echo $row['id'] ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="gmail" name="gmail" class="form-control" value="<?php echo $row['gmail'] ?>" required>
                                    </div>
                                    <div class="col-md-4">
