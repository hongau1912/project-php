<!-- <div class="all-box-time">
    ...
    foreach ($hours as $hour) {
        if ($hour <= $timezone) {
            echo ' <button  type="button" onclick="getInnerText(' . $hour . ')" id="view-text" class="timezone"> ' . $hour . 'h00  </button> ';
        } else {
            echo ' <button  type="button" onclick="getInnerText(' . $hour . ')" id="view-text" class="box_time_item"> ' . $hour . 'h00  </button> ';
        }
    }
    ?>
...
<body>
    ...
    <div>
        <h1 style="text-align: center; color: red; padding: 50px 0px">Bạn vui vòng nhập đầy đủ thông tin!</h1>
    </div>
    <div class="footer">
        <!-- footer-->
        <div class="container">
