            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        <h2 class="page-title">Cảm ơn bạn đã đặt chỗ</h2>
                ...
                <div class="">
                    <div class="service-block">
                        ...
                        <?php
                            ...
                            $customer_gmail = $row['gmail'];
                            $customer_name = $row['name'];
                            $tieude = "Đặt lịch cắt thành công!";
                            $noidung = '<h4 class="title fixcolor">Hi ' . $row['name'] . '</h4>
                                        <h1 class="title fixcolor">Mã đặt chỗ #' . $row['id'] . '</h1>
                                        <h4 class="fixcolor">Cảm ơn bạn đã đặt lịch để sử dụng các dịch vụ của chúng tôi.</h4>
                                        <h4 class="fixcolor">Rất mong được đón tiếp và phục vụ bạn vào lúc ' . $row['time_booking'] . ' ngày ' . $row['date_booking'] . ' tại MAN HAIR SALON</h4>
                                        <h4 class="fixcolor">Hẹn gặp lại bạn!</h4>';
                            $mail = new Mailer();
                            $mail->ordermail($tieude, $noidung, $customer_gmail, $customer_name);
                        ?>
                        <div class="service-content">
                            <!-- service content -->
                            <h2 class="title fixcolor">mã đặt chỗ #<?php echo $row['id'] ?></h2>
                            <p class="fixcolor">Cảm ơn bạn đã đặt lịch để sử dụng các dịch vụ của chúng tôi.</p>
                            <p class="fixcolor">Rất mong được đón tiếp và phục vụ bạn tại MAN HAIR SALON</p>
                            <p class="fixcolor">Hẹn gặp lại bạn!</p>
                            <a id="singlebutton" class="btn btn-default" href="../index.php">Trang chủ</a>
                        </div>
                        <!-- service content -->
                    </div>
                    <!-- /.service block -->
